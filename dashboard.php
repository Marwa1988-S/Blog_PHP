	...
	<body class="dashboard">
		...
		<div class="fleft">
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<?php foreach($categoriesArray AS $category): ?>
					<?php if($catObject and  $catObject->getCat_id() == $category->getCat_id()): ?> 
				...
				<input class="dashboard" type="text" name="blog_headline" placeholder="Überschrift" value="<?php if($blogObject) echo $blogObject->getBlog_headline() ?>"><br>
				...
				<select class="alignment" name="blog_imageAlignment">
					<option value="fleft" <?php if($blogObject and $blogObject->getBlog_imageAlignment() == "fleft") echo "selected"?>>align left</option>
					<option value="fright" <?php if($blogObject and $blogObject->getBlog_imageAlignment() == "fright") echo "selected"?>>align right</option>
				</select>
				...
				<textarea class="dashboard" name="blog_content" placeholder="Text..."><?php if($blogObject) echo $blogObject->getBlog_content() ?></textarea><br>
		...
		<div class="fright">
			...
			<form class="dashboard" action="" method="POST">
				...
				<input class="dashboard" type="text" name="cat_name" placeholder="Name der Kategorie" value="<?php if($catObject)  echo $catObject->getCat_name() ?>"><br>
